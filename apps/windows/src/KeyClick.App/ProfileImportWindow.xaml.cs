...
public partial class ProfileImportWindow : Window
{
  ...
  {
    InitializeComponent();
    Summary.Text = LocalizationService.Current.Format("ProfilePreviewFormat", string.Join(", ", preview.Sections), preview.MediaFileCount,
      preview.StatisticsBucketCount, preview.ChallengeResultCount, preview.SavedPromptCount);
  }
