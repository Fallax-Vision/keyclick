...
public sealed class LocalizationService
{
  ...
  public string EnumName(object value) => value switch
  {
    ...
    PointerThemeScope.SystemWide => Get("PointerScopeSystemWide"),
    PointerThemeScope.KeyClickOnly => Get("PointerScopeKeyClickOnly"),
    PointerThemeScope.PreviewOnly => Get("PointerScopePreviewOnly"),
    PointerCursorSize.Small => Get("PointerSizeSmall"),
    PointerCursorSize.Standard => Get("PointerSizeStandard"),
    PointerCursorSize.Large => Get("PointerSizeLarge"),
    PointerCursorSize.ExtraLarge => Get("PointerSizeExtraLarge"),
    PointerThemeVariant.Automatic => Get("PointerVariantAutomatic"),
    PointerThemeVariant.Light => Get("ThemeLight"),
    PointerThemeVariant.Dark => Get("ThemeDark"),
    PointerThemeVariant.HighContrast => Get("PointerVariantHighContrast"),
    PointerMotionMode.Companion => Get("PointerModeCompanion"),
    PointerMotionMode.FullReplacement => Get("PointerModeReplacement"),
    PointerMotionPreset.None => Get("None"),
    PointerMotionPreset.WindTail => Get("PointerPresetWindTail"),
    PointerMotionPreset.Elastic => Get("PointerPresetElastic"),
    PointerMotionPreset.Comet => Get("PointerPresetComet"),
    PointerMotionPreset.Liquid => Get("PointerPresetLiquid"),
    PointerMotionPreset.Glow => Get("PointerPresetGlow"),
    PointerMotionPreset.ShakeFinder => Get("PointerPresetShakeFinder"),
    PointerClickIndicatorStyle.None => Get("None"),
    PointerClickIndicatorStyle.Ring => Get("PointerClickRing"),
    PointerClickIndicatorStyle.Ripple => Get("PointerClickRipple"),
    PointerClickIndicatorStyle.TinyExplosion => Get("PointerClickExplosion"),
    PointerClickIndicatorStyle.Sparkles => Get("PointerClickSparkles"),
    PointerClickIndicatorStyle.RadialTicks => Get("PointerClickTicks"),
    PointerClickIndicatorStyle.Pulse => Get("PointerClickPulse"),
    PointerActionKind.None => Get("None"),
    PointerActionKind.ToggleSounds => Get("TrayToggleSounds"),
    PointerActionKind.PreviousSoundPack => Get("PointerActionPreviousPack"),
    PointerActionKind.NextSoundPack => Get("PointerActionNextPack"),
    PointerActionKind.TogglePointerEffects => Get("PointerActionToggleEffects"),
    PointerActionKind.NextPointerTheme => Get("PointerActionNextTheme"),
    PointerActionKind.ShowHideKeyClick => Get("PointerActionShowHide"),
    PointerActionKind.BrowserBack => Get("PointerActionBrowserBack"),
    PointerActionKind.BrowserForward => Get("PointerActionBrowserForward"),
    PointerActionKind.MediaPlayPause => Get("PointerActionMediaPlayPause"),
    PointerActionKind.VolumeUp => Get("PointerActionVolumeUp"),
    PointerActionKind.VolumeDown => Get("PointerActionVolumeDown"),
    PointerActionKind.ShowDesktop => Get("PointerActionShowDesktop"),
    PointerActionKind.DisableButton => Get("PointerActionDisableButton"),
    PointerActionKind.LeftClick => Get("PointerActionLeftClick"),
    PointerActionKind.RightClick => Get("PointerActionRightClick"),
    PointerActionKind.MiddleClick => Get("PointerActionMiddleClick"),
